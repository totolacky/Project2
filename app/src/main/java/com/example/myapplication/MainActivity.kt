...
//        testUsers.add(ContactData("0","Tom",null,0,null,testPhotoStrings1,testFriendIds2))
//        testUsers.add(ContactData("1","Mike","feel like Mike",0,null,testPhotoStrings2,testFriendIds1))
//        testUsers.add(ContactData("2","Henry","feel like Henry",0,null,testPhotoStrings1,testFriendIds2))
//        testUsers.add(ContactData("3","Alice","feel sooooo Alice",0,null,testPhotoStrings2,testFriendIds1))
//        testUsers.add(ContactData("4","Julia","hehe",0,null,testPhotoStrings1,testFriendIds2))
//        testUsers.add(ContactData("5","Daniel",null,0,null,testPhotoStrings2,testFriendIds1))
//        testUsers.add(ContactData("6","Steve",null,0,null,testPhotoStrings1,testFriendIds2))
