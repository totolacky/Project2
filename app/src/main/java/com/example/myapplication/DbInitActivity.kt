...
class DbInitActivity : AppCompatActivity() {
    ...
    fun getProfileString(i: String): String{
        var imageStr = "userprofile" + i
        var resID = getResources().getIdentifier(imageStr, "drawable", getPackageName())
        var resBitmap = BitmapFactory.decodeResource(getResources(), resID)
        return Util.getStringFromBitmap(resBitmap)!!
    }
    ...
    fun testData(){
        ...
        testUsers.add(ContactData("","0","Jane","안녕하세요",
            1,getProfileString("0"),getPhotoString("0"),ArrayList(),arrayListOf("HYU","Lion"),ArrayList()))
        testUsers.add(ContactData("","1","Tom","I love beer",
            5,getProfileString("1"),getPhotoString("1"),ArrayList(),arrayListOf("Beer","Friends"),ArrayList()))
        testUsers.add(ContactData("","2","Mike","I am cute",
            2,getProfileString("2"),getPhotoString("2"),ArrayList(),arrayListOf("Cuty"),ArrayList()))
        testUsers.add(ContactData("","3","Henry","я ненавижу сервер",
            3,getProfileString("3"),getPhotoString("3"),ArrayList(),arrayListOf("Sky","Sunset"),ArrayList()))
        testUsers.add(ContactData("","4","Alice","ฉันเกลียดเซิร์ฟเวอร์",
            4,getProfileString("4"),getPhotoString("4"),ArrayList(),arrayListOf("Palace"),ArrayList()))
        testUsers.add(ContactData("","5","Julia","guten Morgen",
            5,getProfileString("5"),getPhotoString("5"),ArrayList(),arrayListOf("Flower"),ArrayList()))
        testUsers.add(ContactData("","6","Daniel","我讨厌服务器",
            6,getProfileString("6"),getPhotoString("6"),ArrayList(),arrayListOf("Mountain","River","Trip"),ArrayList()))
        testUsers.add(ContactData("","7","Steve","صباح الخير",
            7,getProfileString("7"),getPhotoString("7"),ArrayList(),arrayListOf("Cute"),ArrayList()))
        testUsers.add(ContactData("","8","Sophie","힙찔이",
            1,getProfileString("8"),getPhotoString("8"),ArrayList(),arrayListOf("Hiphop"),ArrayList()))
        testUsers.add(ContactData("","9","Timothy","Merry Christmas",
            2,getProfileString("9"),getPhotoString("9"),ArrayList(),arrayListOf("Christmas"),ArrayList()))
        testUsers.add(ContactData("","10","Julien","",
            9,getProfileString("10"),getPhotoString("10"),ArrayList(),arrayListOf("Village","River"),ArrayList()))
        testUsers.add(ContactData("","11","Kevin","Beeeeeer",
            5,getProfileString("11"),getPhotoString("11"),ArrayList(),arrayListOf("House","Unleitung"),ArrayList()))
        testUsers.add(ContactData("","12","Jake","I love Holland",
            8,getProfileString("12"),getPhotoString("12"),ArrayList(),arrayListOf("Windmill","River"),ArrayList()))
        testUsers.add(ContactData("","13","Brian","I love snow",
            10,getProfileString("13"),getPhotoString("13"),ArrayList(),arrayListOf("Snow","Toblerone"),ArrayList()))
